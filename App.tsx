...
const App: React.FC = () => {
  ...
  const [assetTab, setAssetTab] = useState<'available' | 'assigned' | 'crosscheck'>('available');
      ...
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter break-words">{conf.conferenceName || conf.name}</h2>
    ...
    <div className="space-y-8 animate-in slide-in-from-right-8 duration-500">
      ...
      <div className="bg-slate-900/30 rounded-[1.5rem] md:rounded-[2rem] border border-slate-800/50 overflow-hidden">
        ...
        <div className="md:hidden divide-y divide-slate-800/40">
          ...
          {paginatedInventoryAssets.length === 0 && <div className="p-8 text-center text-slate-500 font-black uppercase text-[10px]">No assets found</div>}
        </div>
