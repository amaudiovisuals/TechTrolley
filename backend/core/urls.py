...
urlpatterns = [
    ...
    path('users/reset-password/', user_views.admin_reset_password, name='admin_reset_password'),
    ...
    path('conferences/<int:pk>/trucks/add-to-truck/', truck_views.add_asset_to_truck, name='add_asset_to_truck'),
